...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 345.0, 160.0, 75.0, 43.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 105.0, 253.0, 53.0, 22.0 ],
					"text" : "prepend"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 135.0, 195.0, 72.0, 22.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 135.0, 160.0, 52.0, 22.0 ],
					"text" : "store $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 277.0, 160.0, 58.0, 22.0 ],
					"text" : "delete $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 360.0, 75.0, 57.0, 22.0 ],
					"text" : "tosymbol"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 90.0, 150.0, 345.0, 135.0 ],
					"proportion" : 0.39,
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-44", 0 ],
					"midpoints" : [ 144.5, 240.0, 114.5, 240.0 ],
					"source" : [ "obj-41", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 114.5, 300.0, 39.5, 300.0 ],
					"source" : [ "obj-44", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-31", 0 ],
					"midpoints" : [ 234.5, 300.0, 39.5, 300.0 ],
					"source" : [ "obj-8", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 369.5, 120.0, 286.5, 120.0 ],
					"order" : 0,
					"source" : [ "obj-85", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.811764705882353, 0.372549019607843, 0.372549019607843, 1.0 ],
					"destination" : [ "obj-31", 0 ],
					"midpoints" : [ 369.5, 120.0, 39.5, 120.0 ],
					"order" : 2,
					"source" : [ "obj-85", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 369.5, 120.0, 144.5, 120.0 ],
					"order" : 1,
					"source" : [ "obj-85", 0 ]
				}
